function [sys_red,FITje,Xd,Xd_p,x,FITje_val,fig1,xo,Koop] = ...
    eDynamicmodedecomposition(states,statesvalidDMD,Inputs,Outputs, Deterministic,Deterministic_val,Inputs_val,Outputs_val,method,maindir,dirdmd,dt,stateName,dirFig)
