function [mpc] = H_G_Kmatrix_dU(~,mpc,sol,xinit)
...
E_approx = (L*xinit + S* mpc.utemp - mpc.Pref(sol.k:sol.k+mpc.Nh-1));
...
% gradient :-
mpc.g = 2*(S'*mpc.Q*E_approx + mpc.R*grad_dU)'; 
% Hessian:-
H = 2*(S'*mpc.Q*S + mpc.R*RH);
